...
Note: the above is equivalent to calling `orl_model$parVals` and `orl_model[["parVals"]]`.
...
Suppose we want the trace plots for all parameters related to covariate `x4`:
